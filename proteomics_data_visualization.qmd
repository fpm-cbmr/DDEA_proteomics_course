...
In this example, we do not have any plate ID or batch ID, and fiber_id and fiber_num are sample identifiers. This leaves subject_id and time as biological variables that can be used for downstream analysis. Subject carries information at the individual level, while time carries the information about when during the training intervention were the fibers dissected.
